        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://api.clerk.dev https://clerk.salesblitz.ai https://api.heygen.com wss://*.heygen.com https://api.liveavatar.com wss://*.livekit.cloud https://*.livekit.cloud https://api.anthropic.com https://api.openai.com https://*.supabase.co https://*.stripe.com https://*.vercel-insights.com https://*.vercel-analytics.com",
