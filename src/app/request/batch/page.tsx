        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="w-full rounded-xl border border-[#333333] bg-[#141414] px-4 py-3 text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition"
            >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {accounts.map((account) => (
                <div
                  key={account.id}
                  className="rounded-xl border bg-[#141414] p-5 shadow-sm shadow-black/20 space-y-4"
                >
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-[#333333] bg-[#141414] px-3 py-2 text-sm text-white placeholder-neutral-500 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-neutral-400 mb-2">
            ...
            {accounts.length < 10 && (
              <button
                type="button"
                onClick={addAccount}
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-[#333333] py-3 text-sm font-medium text-neutral-400 hover:border-[#525252] hover:text-neutral-200 transition"
              >
          ...
          <div className="space-y-4 rounded-xl border bg-[#141414] p-5 shadow-sm shadow-black/20">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-[#333333] bg-[#141414] px-3 py-2 text-sm text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition"
              >
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  rows={4}
                  className={`w-full rounded-lg border bg-[#141414] px-3 py-2 text-sm text-white placeholder-neutral-500 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition resize-none ${
                    isListening ? "border-red-300" : "border-[#333333]"
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 rounded-lg border border-[#333333] bg-[#141414] px-4 py-3 text-sm font-medium text-neutral-200 hover:bg-[#0a0a0a] transition"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 py-3 text-sm font-medium text-white hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition"
            >
              {loading ? (
                <>
