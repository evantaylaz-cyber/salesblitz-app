...
const TIERS = [
  {
    ...
    lockedTools: ["Interview Prep", "Prospect Prep", "AI Practice Mode", "Deal Playbook", "Proposal Blitz", "Territory Blitz"],
    highlight: false,
  },
  {
    name: "Pro",
    ...
    lockedTools: ["Deal Playbook", "Proposal Blitz", "Territory Blitz"],
