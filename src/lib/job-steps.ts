...
const STEP_TEMPLATES: Record<ToolName, Omit<JobStep, "status" | "startedAt" | "completedAt">[]> = {
  interview_prep: [
    ...
    { id: "generating_brief", label: "Building Research Brief", description: "Compiling qualification mapping, story bank, call sheet, 30/60/90 plan, and competitive positioning into one comprehensive document." },
    ...
    { id: "generating_call_docs", label: "Generating call prep docs", description: "Building speaker notes, arsenal, and call flow tailored to your interview type." },
  ...
  prospect_prep: [
    ...
    { id: "generating_pov_deck", label: "Generating POV Deck", description: "Building your 5-slide business case deck." },
    { id: "generating_handwritten", label: "Creating handwritten cards", description: "Generating 3 Gemini handwritten reference cards: POV card, 1-image call sheet, 2-image call sheet." },
    { id: "generating_call_docs", label: "Generating call prep docs", description: "Building speaker notes, arsenal, and call flow tailored to your meeting stage." },
...
export function getExpectedAssets(toolName: ToolName): Omit<Asset, "url" | "size">[] {
  const ASSET_TEMPLATES: Record<ToolName, Omit<Asset, "url" | "size">[]> = {
    interview_prep: [
      ...
      { id: "callDoc_speakerNotes", label: "Speaker Notes", format: "pdf", category: "deliverable" },
      { id: "callDoc_arsenal", label: "Arsenal", format: "pdf", category: "deliverable" },
      { id: "callDoc_callFlow", label: "Call Flow", format: "pdf", category: "deliverable" },
