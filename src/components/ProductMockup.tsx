        ...
        <div className="bg-[#0a0a0a] p-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="group rounded-lg border border-[#262626] bg-[#141414] p-3 transition hover:border-emerald-500/20 hover:shadow-sm shadow-black/20">
              ...
              <p className="text-[11px] font-semibold text-white leading-tight">Research Brief</p>
              <p className="text-[10px] text-neutral-500 mt-0.5">PDF &bull; 12 pages</p>
            </div>
            ...
            <div className="group rounded-lg border border-[#262626] bg-[#141414] p-3 transition hover:border-emerald-500/20 hover:shadow-sm shadow-black/20">
              ...
              <p className="text-[11px] font-semibold text-white leading-tight">Call Playbook</p>
              <p className="text-[10px] text-neutral-500 mt-0.5">Interactive HTML</p>
            </div>
            ...
            <div className="group rounded-lg border border-[#262626] bg-[#141414] p-3 transition hover:border-emerald-500/20 hover:shadow-sm shadow-black/20">
              ...
              <p className="text-[11px] font-semibold text-white leading-tight">Stakeholder Map</p>
              <p className="text-[10px] text-neutral-500 mt-0.5">Interactive HTML</p>
            </div>
            ...
            <div className="group rounded-lg border border-[#262626] bg-[#141414] p-3 transition hover:border-emerald-500/20 hover:shadow-sm shadow-black/20">
              ...
              <p className="text-[11px] font-semibold text-white leading-tight">Notebook Card</p>
              <p className="text-[10px] text-neutral-500 mt-0.5">Handwritten PNG</p>
            </div>
          </div>
          ...
          <div className="mt-3 flex items-center justify-center gap-1.5">
            ...
            <span className="ml-1 text-[10px] text-neutral-500">+ Call Prep Sheet, Competitive Playbook</span>
          </div>
        </div>
      </div>
