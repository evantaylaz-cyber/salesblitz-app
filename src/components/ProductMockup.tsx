export default function ProductMockup() {
  return (
    <div className="relative mx-auto max-w-4xl">
      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-2xl shadow-gray-200/50 overflow-hidden">
        ...
        <div className="bg-gray-50 p-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {/* Research Brief */}
            <div className="group rounded-lg border border-gray-200 bg-white p-3 transition hover:border-indigo-200 hover:shadow-sm">
            ...
            {/* POV Deck */}
            <div className="group rounded-lg border border-gray-200 bg-white p-3 transition hover:border-indigo-200 hover:shadow-sm">
              <div className="flex h-20 items-center justify-center rounded-md bg-gradient-to-br from-indigo-50 to-indigo-100 mb-2">
            ...
            {/* Stakeholder Map */}
            <div className="group rounded-lg border border-gray-200 bg-white p-3 transition hover:border-indigo-200 hover:shadow-sm">
              <div className="flex h-20 items-center justify-center rounded-md bg-gradient-to-br from-purple-50 to-purple-100 mb-2">
      ...
      <div className="absolute -bottom-3 -right-3 h-24 w-24 rounded-2xl bg-gradient-to-br from-indigo-100 to-purple-100 -z-10 blur-sm" />
      <div className="absolute -top-3 -left-3 h-16 w-16 rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50 -z-10 blur-sm" />
    </div>
  );
}
